...
from .sub2api_scheduler import router as sub2api_scheduler_router
...
api_router.include_router(sub2api_scheduler_router, prefix="/sub2api-scheduler", tags=["sub2api-scheduler"])
